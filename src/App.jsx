...
const QuizApp = () => {
  ...
  // --- DATA: RUNDE 1 (FRISKE 2025 SPØRGSMÅL - ORDSPILS EDITION) ---
  const realQuestions1 = [
    // 1. STARTER - SPORT
    { q: "Hvilke tre lande delte værtsskabet for VM i Herrehåndbold i januar 2025?", o: ["Danmark, Sverige, Norge", "Danmark, Norge, Kroatien", "Tyskland, Polen, Danmark", "Frankrig, Spanien, Portugal"], a: 1, c: "Vi håndterede det for vildt! Det var ikke en klistret harpiks-situation, men en ren mål-fest. Man må sige, vi havde grebet om tingene." },
    // 2. POLITIK
    { q: "Hvilken begivenhed stjal al opmærksomhed d. 20. januar 2025 i USA?", o: ["Super Bowl", "Indsættelse af Donald Trump", "Det Hvide Hus jubilæum", "Fredsaftale underskrevet"], a: 1, c: "Han trak det længste strå - eller skal vi sige den længste Trump-et? Demokraterne blev Harris'et ud, og nu er Det Hvide Hus igen orange-over." },
    // 3. NATUR (NY)
    { q: "Hvilket naturfænomen toppede i 2025 pga. 'Solar Maximum' og gav vilde syn i Danmark?", o: ["Solformørkelse", "Nordlys", "Tornadoer", "Jordskælv"], a: 1, c: "Himlen var helt grøn af misundelse! Det var en lys-idé fra naturens side. Vi var helt oppe at køre over den magnetiske stemning." },
    // 4. FILM (NY)
    { q: "Hvilken superhelt vendte tilbage i biografen i juli 2025 i filmen 'Legacy'?", o: ["Batman", "Spider-Man", "Superman", "Iron Man"], a: 2, c: "Det var en super-mandlig præstation! Han fløj højere end benzinpriserne. James Gunn ramte plet – det var ikke kryptonit for karrieren." },
    // 5. MUSIK
    ...
    // 6. SPORT
    { q: "Hvilken by var startby for Tour de France 2025?", o: ["København", "Lille (Frankrig)", "Barcelona", "London"], a: 1, c: "En stor start i en Lille by! Rytterne var gearet til tænderne, og det kørte bare deruda'. Det var heldigvis aldrig kæde-ligt at se på." },
    // 7. TECH (NY)
    { q: "Hvilken spillekonsol kom der endelig officielt nyt om fra Nintendo i 2025?", o: ["Switch 2", "GameBoy 2025", "Wii 3", "DS 2025"], a: 0, c: "Vi har trykket på alle knapper for at få den! Det var en game-changer, der fik os til at switche humør. Nu skal der games igennem." },
    // 8. EUROVISION
    ...
    // 11. LANDBRUG (NY)
    { q: "Hvilken afgift trådte store dele af i kraft for landbruget (Grøn Trepart)?", o: ["Vand-afgift", "CO2-afgift", "Traktor-skat", "Gylle-gebyr"], a: 1, c: "Det var en prut-dyr omgang for køerne! Landmændene malkede situationen for alt hvad den kunne trække. En rigtig lorte-sag for nogen." },
    // 12. DR JUBILÆUM
    ...
    // 19. FERRARI
    { q: "Hvilken Formel 1-kører kørte sin første sæson i rødt for Ferrari i 2025?", o: ["Max Verstappen", "Lando Norris", "Lewis Hamilton", "Kevin Magnussen"], a: 2, c: "Han skiftede gear! Det var en rød-glødende nyhed. Man kan sige, han var træt af at være Mercedes-løs og ville prøve flere hestekræfter." },
